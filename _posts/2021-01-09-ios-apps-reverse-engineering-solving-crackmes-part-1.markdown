...
Once our binary is patched, we can put it in place of the fat binary and rebuild the ipa file by just zipping the Payload directory again and intalling
